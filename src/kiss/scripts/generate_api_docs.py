...
def _sort_modules(modules: list[ModuleDoc]) -> list[ModuleDoc]:
    order = [
        ...
        "kiss.agents.sorkar.browser_ui", "kiss.agents.sorkar.useful_tools",
        "kiss.agents.sorkar.web_use_tool",
        ...
        "kiss.agents.sorkar", "kiss.core.relentless_agent",
        "kiss.agents.sorkar.assistant_agent", "kiss.agents.sorkar.sorkar",
        "kiss.agents.sorkar.config",
